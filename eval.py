...
print("\tAverage Tool: " + str(data.TOOL_DATA['build_image']))
print("\tAverage Terminal: " + str(data.TERM_DATA['build_image']))
print("\n\n")
...
print("\tAverage Tool: " + str(data.TOOL_DATA['hello_world']))
print("\tAverage Terminal: " + str(data.TERM_DATA['hello_world']))
